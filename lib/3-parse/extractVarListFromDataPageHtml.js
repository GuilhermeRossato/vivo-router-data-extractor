...
module.exports = function extractVarListFromDataPageHtml(text_or_response) {
    ...
    const vlist = treatedList.filter(
        ...
        if (variableName[0] === '_' || variableName.length < 2 || ['port', 'wep', 'Converted', 'item', 'dns6', 'vodst', 'loc', 'code', 'itm', 'hide5', 'auth5', 'sel', 'calc', 'item', 'tab', 'accessClass'].includes(variableName)) {
