...
exports.sessionArgIndex = sessionArgIndex === -1 ? undefined : sessionArgIndex;
...
const includeIndividualHost = process.argv.some(a => ['--hosts', '--host', '--individual-host', '--keep-host'].includes(a.replace('hosts', 'host')));
exports.includeIndividualHost = includeIndividualHost;

const includeOriginalValue = process.argv.some(a => ['--original', '--raw'].includes(a.replace('hosts', 'host')));
exports.includeOriginalValue = includeOriginalValue;